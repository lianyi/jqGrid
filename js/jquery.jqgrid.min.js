...
d)},l=z.fbRows,m=Va+" ui-subgrid jqgroup jqfoot jqgfirstrow jqgskipselect",n,p=h._index;h.multiPageSelection||da(h.selarrrow);if(this.checked){if(c=!0,h.selrow=1<d.rows.length?d.rows[d.rows.length-1].id:null,h.multiPageSelection&&null!=h.data&&0<h.data.length&&null!=p)for(n in p)p.hasOwnProperty(n)&&h.selarrrow.push(h.idPrefix+n)}else c=!1,h.multiPageSelection?b(d.rows).each(function(){var b=h.selarrrow.indexOf(h.idPrefix+this.id);0<=b&&h.selarrrow.splice(b,1)}):h.selrow=null;var r=c?h.selarrrow:
f;b(d.rows).each(function(a){aa(this,m)||(k(this,c),0>b.inArray(this.id,r)&&r.push(this.id),l&&k(l[a],c))});R.call(d,"onSelectAll",c?h.selarrrow:f,c)});if(!0===h.autowidth){var Oa=Math.floor(b(Q).innerWidth());h.width=0<Oa?Oa:"nw"}isNaN(h.width)?isNaN(parseFloat(h.width))||(h.width=parseFloat(h.width)):h.width=Number(h.width);h.widthOrg=h.width;Eb();b(Q).css("width",z.width+"px").append("<div class='"+F("resizer","ui-jqgrid-resize-mark")+"' id='"+h.rsId+"'>&#160;</div>");b(h.rs).bind("selectstart",
function(){return!1}).click(Z).dblclick(function(a){var f=b(this).data("idx"),g=b(this).data("pageX"),l=h.colModel[f];if(null==g||null==l)return!1;var g=String(g).split(";"),m=parseFloat(g[0]),n=parseFloat(g[1]);if(2===g.length&&(5<Math.abs(m-n)||5<Math.abs(a.pageX-m)||5<Math.abs(a.pageX-n)))return!1;R.call(d,"resizeDblClick",f,l,a)&&l.autoResizable&&c.autoResizeColumn.call(k,f);R.call(d,"afterResizeDblClick",{iCol:f,cm:l,cmName:l.name});return!1});b(C).css("width",z.width+"px");var Ha="";h.footerrow&&
(Ha+="<table role='presentation' style='width:1px' class='"+F("gridFooter","ui-jqgrid-ftable")+"'><tbody><tr role='row' class='"+F("rowFooter","footrow footrow-"+ca)+"'>");var Ka="<tr class='jqgfirstrow' role='row' style='height:auto'>";h.disableClick=!1;b("th",wa[0].tHead.rows[0]).each(function(a){var c=h.colModel[a],d=c.name,e=b(this),f=e.children("div"),g=f.children("span.s-ico"),k=h.showOneSortIcon;ea=c.width;void 0===c.resizable&&(c.resizable=!0);c.resizable?(fb=document.createElement("span"),
b(fb).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+ca).bind("selectstart",function(){return!1}),e.addClass(h.resizeclass)):fb="";e.css("width",ea+"px").prepend(fb);fb=null;var l="";!0===c.hidden&&(e.css("display","none"),l="display:none;");Ka+="<td role='gridcell' "+(c.classes?"class='"+c.classes+"' ":"")+"style='height:0;width:"+ea+"px;"+l+"'></td>";z.headers[a]={width:ea,el:this};fa=c.sortable;"boolean"!==typeof fa&&(fa=c.sortable=!0);"cb"!==d&&"subgrid"!==d&&"rn"!==d&&fa&&h.viewsortcols[2]&&
f.addClass("ui-jqgrid-sortable");fa&&(h.multiSort?(d="desc"===c.lso?"asc":"desc",h.viewsortcols[0]?(g.css("display",""),c.lso&&(g.children("span.ui-icon-"+c.lso).removeClass(Va),k&&g.children("span.ui-icon-"+d).hide())):c.lso&&(g.css("display",""),g.children("span.ui-icon-"+c.lso).removeClass(Va),k&&g.children("span.ui-icon-"+d).hide())):(d="desc"===h.sortorder?"asc":"desc",h.viewsortcols[0]?(g.css("display",""),a===h.lastsort&&(g.children("span.ui-icon-"+h.sortorder).removeClass(Va),k&&g.children("span.ui-icon-"+
d).hide())):a===h.lastsort&&""!==c.lso&&(g.css("display",""),g.children("span.ui-icon-"+h.sortorder).removeClass(Va),k&&g.children("span.ui-icon-"+d).hide())));h.footerrow&&(Ha+="<td role='gridcell' "+S(a,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(a){var c=b(this),d=c.closest(".ui-jqgrid-hdiv").hasClass("frozen-div"),e=function(){var a=[c.position().left+c.outerWidth()];"rtl"===h.direction&&(a[0]=h.width-a[0]);a[0]-=d?0:z.bDiv.scrollLeft;a.push(b(z.hDiv).position().top);a.push(b(z.bDiv).offset().top-
b(z.hDiv).offset().top+b(z.bDiv).height()+(z.sDiv?b(z.sDiv).height():0));return a},f;if(1===b(a.target).closest("th>span.ui-jqgrid-resize").length)return f=h.iColByName[(this.id||"").substring(h.id.length+1)],null!=f&&(!0===h.forceFit&&(h.nv=Fb(f)),z.dragStart(f,a,e(),c)),!1}).click(function(a){if(h.disableClick)return h.disableClick=!1;var c="th.ui-th-column>div",f,g,c=h.viewsortcols[2]?c+".ui-jqgrid-sortable":c+">span.s-ico>span.ui-grid-ico-sort";a=b(a.target).closest(c);if(1===a.length)return h.viewsortcols[2]||
(f=!0,g=a.hasClass("ui-icon-desc")?"desc":"asc"),a=h.iColByName[(this.id||"").substring(h.id.length+1)],null!=a&&Y.call(d,b("div",this)[0].id,a,f,g,this),!1});if(h.sortable&&b.fn.sortable)try{c.sortableColumns.call(k,b(wa[0].tHead.rows[0]))}catch(rb){}h.footerrow&&(Ha+="</tr></tbody></table>");Ka+="</tr>";k.html("<tbody>"+Ka+"</tbody>");k.addClass(F("grid","ui-jqgrid-btable"+(!0===h.altRows&&k.jqGrid("isBootstrapGuiStyle")?" table-striped":"")));var Ba=h.caption&&!0===h.hiddengrid?!0:!1,ab=b("<div class='ui-jqgrid-hbox"+
("rtl"===ca?"-rtl":"")+"'></div>"),Sa=F("top"),Ia=F("bottom");z.hDiv=document.createElement("div");b(z.hDiv).css({width:z.width+"px"}).addClass(F("hDiv","ui-jqgrid-hdiv")).append(ab).scroll(function(){var a=b(this).next(".ui-jqgrid-bdiv")[0];a&&(a.scrollLeft=this.scrollLeft);return!1});b(ab).append(wa);wa=null;Ba&&b(z.hDiv).hide();h.rowNum=parseInt(h.rowNum,10);if(isNaN(h.rowNum)||0>=h.rowNum)h.rowNum=h.maxRowNum;if(h.pager){var Qa,Wa;"string"===typeof h.pager&&"#"!==h.pager.substr(0,1)?(Wa=h.pager,
Qa=b("#"+G(h.pager))):!0===h.pager?(Wa=Da(),Qa=b("<div id='"+Wa+"'></div>"),Qa.appendTo("body"),h.pager="#"+G(Wa)):(Qa=b(h.pager),Wa=Qa.attr("id"));0<Qa.length?(Qa.css({width:z.width+"px"}).addClass(F("pager.pager","ui-jqgrid-pager "+Ia)).appendTo(Q),Ba&&Qa.hide(),tb.call(d,Wa,""),h.pager="#"+G(Wa)):h.pager=""}!1===h.cellEdit&&!0===h.hoverrows&&k.bind("mouseover",function(a){ma=b(a.target).closest("tr.jqgrow");"ui-subgrid"!==b(ma).attr("class")&&b(ma).addClass(ta)}).bind("mouseout",function(a){ma=
b(a.target).closest("tr.jqgrow");b(ma).removeClass(ta)});var sa,La,Ta,Ma=function(a){var c,d;do if(c=b(a).closest("td"),0<c.length){a=c.parent();d=a.parent().parent();if(a.is(".jqgrow")&&(d[0]===this||d.is("table.ui-jqgrid-btable")&&(d[0].id||"").replace("_frozen","")===this.id))break;a=c.parent()}while(0<c.length);return c};k.before(z.hDiv).click(function(a){var f=F("states.select"),g=a.target,l=Ma.call(this,g),m=l.parent();if(0!==m.length&&!aa(m,Va)){sa=m[0].id;var n=b(g).hasClass("cbox")&&b(g).is(":enabled")&&
!aa(g,Va),p=R.call(d,"beforeSelectRow",sa,a),r=u.detectRowEditing.call(d,sa),r=null!=r&&"cellEditing"!==r.mode;if("A"!==g.tagName&&(!r||n))if(La=l[0].cellIndex,Ta=l.html(),R.call(d,"onCellSelect",sa,La,Ta,a),!0===h.cellEdit)if(h.multiselect&&n&&p)t.call(k,sa,!0,a);else{sa=m[0].rowIndex;try{c.editCell.call(k,sa,La,!0)}catch(q){}}else if(p)if(h.multikey)a[h.multikey]?t.call(k,sa,!0,a):h.multiselect&&n&&(n=b("#jqg_"+G(h.id)+"_"+sa).is(":checked"),b("#jqg_"+G(h.id)+"_"+sa).prop("checked",!n));else if(h.multiselect&&
h.multiboxonly){if(!n){var v=h.frozenColumns?h.id+"_frozen":"";b(h.selarrrow).each(function(a,d){var e=c.getGridRowById.call(k,d);e&&b(e).removeClass(f);b("#jqg_"+G(h.id)+"_"+G(d)).prop("checked",!1);v&&(b("#"+G(d),"#"+G(v)).removeClass(f),b("#jqg_"+G(h.id)+"_"+G(d),"#"+G(v)).prop("checked",!1))});da(h.selarrrow)}t.call(k,sa,!0,a)}else g=h.selrow,t.call(k,sa,!0,a),"toggle"!==h.singleSelectClickMode||h.multiselect||g!==sa||(this.grid.fbRows&&(m=m.add(this.grid.fbRows[sa])),m.removeClass(f).attr({"aria-selected":"false",
tabindex:"-1"}),h.selrow=null);else n&&b(g).prop("checked",!1)}}).bind("reloadGrid",function(a,d){var e=this.grid,f=b(this);!0===h.treeGrid&&(h.datatype=h.treedatatype);d=n({},Aa.reloadGridOptions||{},h.reloadGridOptions||{},d||{});"local"===h.datatype&&h.dataTypeOrg&&h.loadonce&&d.fromServer&&(h.datatype=h.dataTypeOrg,delete h.dataTypeOrg);d.current&&e.selectionPreserver.call(this);"local"===h.datatype?(h.multiPageSelection||c.resetSelection.call(f),h.data.length&&(ia.call(this),qa())):h.treeGrid||
h.multiPageSelection||(h.selrow=null,h.multiselect&&(da(h.selarrrow),jb.call(this,!1)),da(h.savedRow));h.iRow=-1;h.iCol=-1;h.scroll&&z.emptyRows.call(this,!0,!1);if(d.page){var g=parseInt(d.page,10);g>h.lastpage&&(g=h.lastpage);1>g&&(g=1);h.page=g;e.bDiv.scrollTop=e.prevRowHeight?(g-1)*e.prevRowHeight*h.rowNum:0}e.prevRowHeight&&h.scroll&&void 0===d.page?(delete h.lastpage,e.populateVisible.call(this)):e.populate.call(this);!0===h._inlinenav&&f.jqGrid("showAddEditButtons",!1);return!1}).dblclick(function(b){var a=
Ma.call(this,b.target),c=a.parent();if(0<a.length&&!R.call(d,"ondblClickRow",c.attr("id"),c[0].rowIndex,a[0].cellIndex,b))return!1}).bind("contextmenu",function(b){var a=Ma.call(this,b.target),c=a.parent(),f=c.attr("id");if(0!==a.length&&(h.multiselect||t.call(k,f,!0,b),!R.call(d,"onRightClickRow",f,c[0].rowIndex,a[0].cellIndex,b)))return!1});z.bDiv=document.createElement("div");N&&"auto"===String(h.height).toLowerCase()&&(h.height="100%");b(z.bDiv).append(b("<div style='position:relative;'></div>").append("<div></div>").append(d)).addClass("ui-jqgrid-bdiv").css({height:h.height+
(isNaN(h.height)?"":"px"),width:z.width+"px"}).scroll(z.scrollGrid);h.maxHeight&&b(z.bDiv).css("max-height",h.maxHeight+(isNaN(h.maxHeight)?"":"px"));k.css({width:"1px"});b.support.tbody||2===b(">tbody",d).length&&b(">tbody:gt(0)",d).remove();h.multikey&&b(z.bDiv).bind(u.msie?"selectstart":"mousedown",function(){return!1});Ba&&b(z.bDiv).hide();z.cDiv=document.createElement("div");var Ra=E("gridMinimize.visible"),Xa=E("gridMinimize.hidden"),Ya=B("showhide"),Ua=!0===h.hidegrid?b("<a role='link' class='"+
F("titleButton","ui-jqgrid-titlebar-close")+"'"+(Ya?" title='"+Ya+"'":"")+"/>").hover(function(){Ua.addClass(ta)},function(){Ua.removeClass(ta)}).append("<span class='"+Ra+"'></span>"):"";b(z.cDiv).append("<span class='ui-jqgrid-title'>"+h.caption+"</span>").append(Ua).addClass(F("gridTitle","ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===ca?"-rtl ":" ")+Sa));b(z.cDiv).insertBefore(z.hDiv);if(h.toolbar[0]){z.uDiv=document.createElement("div");"top"===h.toolbar[1]?b(z.uDiv).insertBefore(z.hDiv):"bottom"===
h.toolbar[1]&&b(z.uDiv).insertAfter(z.hDiv);var Za=F("toolbarUpper","ui-userdata");"both"===h.toolbar[1]?(z.ubDiv=document.createElement("div"),b(z.uDiv).addClass(Za).attr("id","t_"+h.id).insertBefore(z.hDiv),b(z.ubDiv).addClass(F("toolbarBottom","ui-userdata")).attr("id","tb_"+h.id).insertAfter(z.hDiv),Ba&&b(z.ubDiv).hide()):b(z.uDiv).width(z.width).addClass(Za).attr("id","t_"+h.id);Ba&&b(z.uDiv).hide()}"string"===typeof h.datatype&&(h.datatype=h.datatype.toLowerCase());h.toppager?(h.toppager=h.id+
"_toppager",z.topDiv=b("<div id='"+h.toppager+"'></div>")[0],b(z.topDiv).addClass(F("pager.pager","ui-jqgrid-toppager"+(h.caption?"":" "+Sa))).css({width:z.width+"px"}).insertBefore(z.hDiv),tb.call(d,h.toppager,"_t"),h.toppager="#"+G(h.toppager)):""!==h.pager||h.scroll||(h.rowNum=h.maxRowNum);h.footerrow&&(z.sDiv=b("<div class='ui-jqgrid-sdiv'></div>")[0],ab=b("<div class='ui-jqgrid-hbox"+("rtl"===ca?"-rtl":"")+"'></div>"),b(z.sDiv).append(ab).width(z.width).insertAfter(z.hDiv),b(ab).append(Ha),z.footers=
b(".ui-jqgrid-ftable",z.sDiv)[0].rows[0].cells,h.rownumbers&&(z.footers[0].className=F("rowNum","jqgrid-rownum")),Ba&&b(z.sDiv).hide());ab=null;if(h.caption){var cb=h.datatype;!0===h.hidegrid&&(b(".ui-jqgrid-titlebar-close",z.cDiv).click(function(a){var c=".ui-jqgrid-bdiv,.ui-jqgrid-hdiv,.ui-jqgrid-pager,.ui-jqgrid-sdiv",f=this;!0===h.toolbar[0]&&("both"===h.toolbar[1]&&(c+=",#"+G(b(z.ubDiv).attr("id"))),c+=",#"+G(b(z.uDiv).attr("id")));var g=b(c,h.gView).length;h.toppager&&(c+=","+h.toppager);"visible"===
h.gridstate?b(c,h.gBox).slideUp("fast",function(){g--;0===g&&(b("span",f).removeClass(Ra).addClass(Xa),h.gridstate="hidden",b(h.gBox).hasClass("ui-resizable")&&b(".ui-resizable-handle",h.gBox).hide(),b(z.cDiv).addClass(Ia),Ba||R.call(d,"onHeaderClick",h.gridstate,a))}):"hidden"===h.gridstate&&(b(z.cDiv).removeClass(Ia),b(c,h.gBox).slideDown("fast",function(){g--;0===g&&(b("span",f).removeClass(Xa).addClass(Ra),Ba&&(h.datatype=cb,ka.call(d),Ba=!1),h.gridstate="visible",b(h.gBox).hasClass("ui-resizable")&&
b(".ui-resizable-handle",h.gBox).show(),Ba||R.call(d,"onHeaderClick",h.gridstate,a))}));return!1}),Ba&&(h.datatype="local",b(".ui-jqgrid-titlebar-close",z.cDiv).trigger("click")))}else b(z.cDiv).hide(),b(z.cDiv).nextAll("div:visible").first().addClass("ui-corner-top");b(z.hDiv).after(z.bDiv);z.eDiv=b("<div class='"+F("gridError","ui-jqgrid-errorbar ui-jqgrid-errorbar-"+ca)+"' style='display:none;'><span class='"+F("gridErrorText","ui-jqgrid-error")+"'></span></div>")[0];b(z.hDiv).after(z.eDiv);b(Q).click(Z).dblclick(function(a){var f=
...
"onSelectRow",k.id,f,d)):"ui-subgrid"!==k.className&&(g.selrow!==k.id?(null!==g.selrow&&(f=l.call(f,g.selrow))&&n(f,!1),n(k,!0),f=!0):f=!1,g.selrow=k.id,c&&R.call(this,"onSelectRow",k.id,f,d))))})},resetAllSelection:function(){this.resetSelection();return this.each(function(){b(this);da(this.p.selarrrow)})},resetSelection:function(a){return this.each(function(){var c=b(this),d=this.p,e=C.getGuiStyles,f=C.getGridRowById,g=e.call(c,"states.select"),k="edit-cell "+g,e="selected-row "+e.call(c,"states.hover"),
m=d.iColByName.cb,l=void 0!==m,n=this.grid.fbRows,p=function(a){var c={"aria-selected":"false",tabindex:"-1"};b(a).removeClass(g).attr(c);l&&b(a.cells[m]).children("input.cbox").prop("checked",!1);n&&(a=n[a.rowIndex],b(a).removeClass(g).attr(c),l&&b(a.cells[m]).children("input.cbox").prop("checked",!1))};void 0!==a?(c=f.call(c,a),p(c),l&&(this.setHeadCheckBox(!1),c=b.inArray(a,d.selarrrow),-1!==c&&d.selarrrow.splice(c,1))):d.multiselect?(b(this.rows).each(function(){var a=b.inArray(this.id,d.selarrrow);
-1!==a&&(p(this),d.selarrrow.splice(a,1))}),this.setHeadCheckBox(!1),d.multiPageSelection||da(d.selarrrow),d.selrow=null):d.selrow&&(c=f.call(c,d.selrow),p(c),d.selrow=null);!0===d.cellEdit&&0<=parseInt(d.iCol,10)&&0<=parseInt(d.iRow,10)&&(c=this.rows[d.iRow],null!=c&&(b(c.cells[d.iCol]).removeClass(k),b(c).removeClass(e)),n&&(c=n[d.iRow],null!=c&&(b(c.cells[d.iCol]).removeClass(k),b(c).removeClass(e))));da(d.savedRow)})},getRowData:function(a,c){var d={},e;"object"===typeof a&&(c=a,a=void 0);c=c||
{};this.each(function(){var f=this.p,g=!1,k,m=2,l=0,n=this.rows,p,q,r,t,u;if(void 0===a)g=!0,e=[],m=n.length;else if(k=C.getGridRowById.call(b(this),a),!k)return d;for(;l<m;){g&&(k=n[l]);if(b(k).hasClass("jqgrow")){q=b("td[role=gridcell]",k);for(p=0;p<q.length;p++)if(r=f.colModel[p],t=r.name,!("cb"===t||"subgrid"===t||"rn"===t||"actions"===r.formatter||c.skipHidden&&r.hidden))if(u=q[p],!0===f.treeGrid&&t===f.ExpandColumn)d[t]=Oa(b("span",u).first().html());else try{d[t]=b.unformat.call(this,u,{rowId:k.id,
colModel:r},p)}catch(y){d[t]=Oa(b(u).html())}!c.includeId||!1!==f.keyName&&null!=d[f.keyName]||(d[f.prmNames.id]=Na(f.idPrefix,k.id));g&&(e.push(d),d={})}l++}});return e||d},delRowData:function(a){var c=!1,d,e,f;this.each(function(){var g=this.p;d=C.getGridRowById.call(b(this),a);if(!d)return!1;g.subGrid&&(f=b(d).next(),f.hasClass("ui-subgrid")&&f.remove());b(d).remove();g.records--;g.reccount--;this.updatepager(!0,!1);c=!0;g.multiselect&&(e=b.inArray(a,g.selarrrow),-1!==e&&g.selarrrow.splice(e,1));
g.multiselect&&0<g.selarrrow.length?g.selrow=g.selarrrow[g.selarrrow.length-1]:g.selrow===a&&(g.selrow=null);if("local"===g.datatype){var k=Na(g.idPrefix,a),k=g._index[k];void 0!==k&&(g.data.splice(k,1),this.refreshIndex())}this.rebuildRowIndexes();if(!0===g.altRows&&c&&!b(this).jqGrid("isBootstrapGuiStyle")){var m=g.altclass,l=this.grid.fbRows;b(this.rows).each(function(a){var c=b(this);l&&(c=c.add(l[this.rowIndex]));c[0===a%2?"addClass":"removeClass"](m)})}R.call(this,"afterDelRow",a)});return c},
setRowData:function(a,c,d){var e=!0;this.each(function(){var f=this,g=f.p,k,m=typeof d,l={};if(!f.grid)return!1;k=C.getGridRowById.call(b(f),a);if(!k)return!1;if(c)try{var n=Na(g.idPrefix,a),p,q=g._index[n],r={},t=null!=q?g.data[q]:void 0;b(g.colModel).each(function(a){var d=this.name,e=pa(c,d);void 0!==e&&("local"===g.datatype&&null!=t&&(e=cb.call(f,e,this,t[d],n,t,a),b.isFunction(this.saveLocally)?this.saveLocally.call(f,{newValue:e,newItem:l,oldItem:t,id:n,cm:this,cmName:d,iCol:a}):l[d]=e),r[d]=
...
if("local"===g.datatype){if(g.treeGrid)for(p in g.treeReader)g.treeReader.hasOwnProperty(p)&&delete l[g.treeReader[p]];void 0!==t&&(g.data[q]=b.extend(!0,t,l))}R.call(f,"afterSetRow",{rowid:a,inputData:c,iData:q,iRow:k.rowIndex,tr:k,localData:l,cssProp:d})}catch(u){e=!1}e&&("string"===m?b(k).addClass(d):null!==d&&"object"===m&&b(k).css(d))});return e},addRowData:function(a,c,d,e){0>b.inArray(d,"first last before after afterSelected beforeSelected".split(" "))&&(d="last");var f=!1,g,k,m,l,n,p,q,r,
t,w,y;c&&(b.isArray(c)?(p=!0,q=a):(c=[c],p=!1),this.each(function(){var x=this.p,D=c.length,v=b(this),A=this.rows,E=0,F=C.getGridRowById,h=x.colModel,B,K=x.additionalProperties;p||(void 0!==a?a=String(a):(a=Da(),!1!==x.keyName&&(q=x.keyName,void 0!==c[0][q]&&(a=c[0][q]))));for(r=x.altclass;E<D;){t=c[E];k=[];if(p)try{a=t[q],void 0===a&&(a=Da())}catch(H){a=Da()}y=a;B={};for(l=0;l<h.length;l++)w=h[l],g=w.name,"rn"!==g&&"cb"!==g&&"subgrid"!==g&&(n=cb.call(this,t[g],w,void 0,y,{},l),b.isFunction(w.saveLocally)?
w.saveLocally.call(this,{newValue:n,newItem:B,oldItem:{},id:y,cm:w,cmName:g,iCol:l}):void 0!==n&&(B[g]=n));for(l=0;l<K.length;l++)g=K[l],"object"===typeof g&&g.hasOwnProperty("name")&&(g=g.name),n=pa(t,g),void 0!==n&&(B[g]=n);"local"===x.datatype&&(B[x.localReader.id]=y,x._index[y]=x.data.length,x.data.push(B));k=u.parseDataToHtml.call(this,1,[a],[t]);k=k.join("");if(0===A.length)b(this.tBodies[0]).append(k);else{if("afterSelected"===d||"beforeSelected"===d)void 0===e&&null!==x.selrow?(e=x.selrow,
d="afterSelected"===d?"after":"before"):d="afterSelected"===d?"last":"first";switch(d){case "last":b(A[A.length-1]).after(k);m=A.length-1;break;case "first":b(A[0]).after(k);m=1;break;case "after":if(m=F.call(v,e))b(A[m.rowIndex+1]).hasClass("ui-subgrid")?(b(A[m.rowIndex+1]).after(k),m=m.rowIndex+2):(b(m).after(k),m=m.rowIndex+1);break;case "before":if(m=F.call(v,e))b(m).before(k),m=m.rowIndex-1}}!0===x.subGrid&&C.addSubGrid.call(v,x.iColByName.subgrid,m);x.records++;x.reccount++;0===x.lastpage&&
(x.lastpage=1);R.call(this,"afterAddRow",{rowid:a,inputData:c,position:d,srcRowid:e,iRow:m,localData:B,iData:x.data.length-1});E++}!0!==x.altRows||p||v.jqGrid("isBootstrapGuiStyle")||("last"===d?0===(A.length-1)%2&&b(A[A.length-1]).addClass(r):b(A).each(function(a){1===a%2?b(this).addClass(r):b(this).removeClass(r)}));this.rebuildRowIndexes();this.updatepager(!0,!0);f=!0}));return f},footerData:function(a,c,d){var e=!1,f={};null==a&&(a="get");"boolean"!==typeof d&&(d=!0);a=a.toLowerCase();this.each(function(){var g=
this.p,k,m,l,n;if(!this.grid||!g.footerrow)return!1;if(k="set"===a)a:{for(m in c)if(c.hasOwnProperty(m)){k=!1;break a}k=!0}if(k)return!1;e=!0;k=b(this.grid.sDiv).children(".ui-jqgrid-hbox").children(".ui-jqgrid-ftable")[0];if(null==k||null==k.rows)return!1;var p=k.rows[0].cells,q=null==this.grid.fsDiv?{}:this.grid.fsDiv.children(".ui-jqgrid-ftable")[0].rows[0].cells;for(l in c)n=g.iColByName[l],c.hasOwnProperty(l)&&void 0!==n&&("get"===a?f[l]=b(p[n]).html():"set"===a&&(k=d?this.formatter("",c[l],
n,c,"edit"):c[l],m=b(p[n]).add(q[n]),m.html(k),g.colModel[n].title&&m.attr({title:lb(k)})))});return"get"===a?f:e},showHideCol:function(a,c,d){return this.each(function(){var e=this,f=b(e),g=e.grid,k=!1,m=e.p,l=u.cell_width?0:m.cellLayout,n;if(g){"string"===typeof a&&(a=[a]);c="none"!==c&&!1!==c?"":"none";d=d||{};var p=""===c?!0:!1,q=m.groupHeader;(q=q&&("object"===typeof q||b.isFunction(q)))&&!d.skipSetGroupHeaders&&C.destroyGroupHeader.call(f,!1);b(m.colModel).each(function(f){if(-1!==b.inArray(this.name,
a)&&this.hidden===p){if(!0===m.frozenColumns&&!0===this.frozen&&!d.notSkipFrozen)return!0;var r=b(g.hDiv).find(".ui-jqgrid-htable>thead>tr");!0===m.frozenColumns&&null!=g.fhDiv&&(r=r.add(b(g.fhDiv).find(".ui-jqgrid-htable>thead>tr")));r.each(function(){b(this.cells[f]).css("display",c)});r=b(e.rows);!0===m.frozenColumns&&null!=g.fbRows&&(r=r.add(g.fbRows));r.each(function(){var a=this.cells[f];(!b(this).hasClass("jqgroup")||null!=a&&1===a.colSpan)&&b(a).css("display",c)});m.footerrow&&(r=b(g.sDiv).find("tr.footrow"),
...
c)})},remapColumns:function(a,c,d){function e(){var b=[],c=[],d,e=a.length;for(d=0;d<e;d++)q&&a[d]<r?b.push(a[d]):c.push(a[d]);return b.concat(c)}function f(a){var c=a.length?p(a):b.extend({},a);b.each(t,function(b){a[b]=c[this]})}function g(a,c){(c?a.children(c):a.children()).each(function(){var a=this,c=p(a.cells);b.each(t,function(b){var d=c[this],e=a.cells[b];null!=d&&null!=e&&d.cellIndex!==b&&d.parentNode.insertBefore(d,e)})})}var k=this[0],m=k.p,l=k.grid,n,p=b.makeArray,q=!0===m.frozenColumns,
r=this.jqGrid("getNumberOfFrozenColumns"),t;if(null!=l&&null!=m){t=e();f(m.colModel);f(m.colNames);f(l.headers);n=b(l.hDiv).children("div").children("table.ui-jqgrid-htable").children("thead");q&&null!=l.fhDiv&&(n=n.add(l.fhDiv.children("table.ui-jqgrid-htable").children("thead")));g(n,d&&":not(.ui-jqgrid-labels)");c&&(n=b(k.tBodies[0]),q&&null!=l.fbDiv&&(n=n.add(l.fbDiv.children("table.ui-jqgrid-btable").children("tbody").first())),g(n,"tr.jqgfirstrow,tr.jqgrow,tr.jqfoot"));m.footerrow&&(n=b(l.sDiv).children("div").children("table.ui-jqgrid-ftable").children("tbody").first(),
q&&null!=l.fsDiv&&(n=n.add(l.fsDiv.children("table.ui-jqgrid-ftable").children("tbody").first())),g(n));m.remapColumns&&(m.remapColumns.length?f(m.remapColumns):m.remapColumns=p(t));m.lastsort=b.inArray(m.lastsort,t);m.iColByName={};l=0;for(n=m.colModel.length;l<n;l++)m.iColByName[m.colModel[l].name]=l;R.call(k,"onRemapColumns",t,c,d)}},remapColumnsByName:function(a,c,d){var e=this[0].p,f=[],g,k;a=a.slice();g=b.inArray;e.subGrid&&0>g("subgrid",a)&&a.unshift("subgrid");e.multiselect&&0>g("cb",a)&&
...
a.empty().html(c)[g.sortIconsBeforeText?"prepend":"append"](d))}),g.colNames[f]=c),d&&("string"===typeof d?k.addClass(d):k.css(d)),"object"===typeof e&&k.attr(e))}})},setCell:function(a,c,d,e,f,g){return this.each(function(){var k=this.p,m,l=k.colModel,n,p,q,r,t,w,y,x={},D;if(this.grid&&(m=isNaN(c)?k.iColByName[c]:parseInt(c,10),0<=m&&(r=C.getGridRowById.call(b(this),a)))){t=u.getCell.call(this,r,m);if(""!==d||!0===g){p=l[m];"local"===k.datatype&&(D=Na(k.idPrefix,a),n=k._index[D],void 0!==n&&(q=k.data[n]));
if(null==q)for(n=0;n<r.cells.length;n++){if(n!==m&&(w=u.getDataFieldOfCell.call(this,r,n),0<w.length)){try{y=b.unformat.call(this,w,{rowId:a,colModel:l[n]},n)}catch(v){y=Oa(w[0].innerHTML)}x[l[n].name]=y}}else x=q;x[p.name]=d;l=this.formatter(a,d,m,x,"edit");y=t;!0===k.treeGrid&&p.name===k.ExpandColumn&&(y=y.children("span.cell-wrapperleaf,span.cell-wrapper").first());y.html(l);p.title&&t.attr({title:d});null!=q&&(l=cb.call(this,d,p,q[p.name],D,q,m),b.isFunction(p.saveLocally)?p.saveLocally.call(this,
{newValue:l,newItem:q,oldItem:q,id:D,cm:p,cmName:p.name,iCol:m}):q[p.name]=l)}if(e||f){t=u.getCell.call(this,r,m);if(e)t["string"===typeof e?"addClass":"css"](e);"object"===typeof f&&t.attr(f)}}})},getCell:function(a,c){var d=!1;this.each(function(){var e,f=this.p,g,k;if(this.grid&&(e=isNaN(c)?f.iColByName[c]:parseInt(c,10),0<=e&&(g=C.getGridRowById.call(b(this),a)))){k=u.getDataFieldOfCell.call(this,g,e).first();try{d=b.unformat.call(this,k,{rowId:g.id,colModel:f.colModel[e]},e)}catch(m){d=Oa(k.html())}}});
return d},getCol:function(a,c,d){var e=[],f,g=0,k,m,l;c="boolean"!==typeof c?!1:c;void 0===d&&(d=!1);this.each(function(){var n,p=this.p,q;if(this.grid&&(n=isNaN(a)?p.iColByName[a]:parseInt(a,10),0<=n)){var r=this.rows,t=r.length,w=0,y=0,x;if(t&&0<t){for(;w<t;){x=r[w];if(b(x).hasClass("jqgrow")){q=u.getDataFieldOfCell.call(this,x,n).first();try{f=b.unformat.call(this,q,{rowId:x.id,colModel:p.colModel[n]},n)}catch(D){f=Oa(q.html())}d?(l=parseFloat(f),isNaN(l)||(g+=l,void 0===m&&(m=k=l),k=Math.min(k,
l),m=Math.max(m,l),y++)):c?e.push({id:x.id,value:f}):e.push(f)}w++}if(d)switch(d.toLowerCase()){case "sum":e=g;break;case "avg":e=g/y;break;case "count":e=t-1;break;case "min":e=k;break;case "max":e=m}}}});return e},clearGridData:function(a){return this.each(function(){var c=this.p,d=this.rows,e=this.grid;e&&c&&d&&("boolean"!==typeof a&&(a=!1),b(this).unbind(".jqGridFormatter"),e.emptyRows.call(this,!1,!0),c.footerrow&&a&&b(".ui-jqgrid-ftable td",e.sDiv).html("&#160;"),c.selrow=null,da(c.selarrrow),
da(c.savedRow),da(c.data),da(c.lastSelectedData),c._index={},c.rowIndexes={},c.records=0,c.page=1,c.lastpage=0,c.reccount=0,this.updatepager(!0,!1))})},getInd:function(a,c){var d=C.getGridRowById.call(b(this),a);return d?!0===c?d:d.rowIndex:!1},bindKeys:function(a){var c=b.extend({onEnter:null,onSpace:null,onLeftKey:null,onRightKey:null,scrollingRows:!0},a||{});return this.each(function(){var a=this,e=a.p,f=b(a);e.scrollrows=c.scrollingRows;f.bind("keydown.jqGrid",function(g){var k=b(this).find("tr[tabindex=0]")[0],
m=u.detectRowEditing.call(a,b(g.target).closest("tr.jqgrow").attr("id")),l=function(a){do if(k=k[a],null===k)return;while(b(k).is(":hidden")||!b(k).hasClass("jqgrow"));C.setSelection.call(f,k.id,!0);g.preventDefault()},n=function(g,k){var l=c["on"+g+(k||"")];f.triggerHandler("jqGridKey"+g,[e.selrow]);b.isFunction(l)&&l.call(a,e.selrow)},p=function(a){if(e.treeGrid){var c=e.data[e._index[Na(e.idPrefix,k.id)]][e.treeReader.expanded_field];"Right"===a&&(c=!c);c&&b(k).find("div.treeclick").trigger("click")}n(a,
"Key")};if(k&&null===m)switch(g.keyCode){case 38:l("previousSibling");break;case 40:l("nextSibling");break;case 37:p("Left");break;case 39:p("Right");break;case 13:n("Enter");break;case 32:n("Space")}})})},unbindKeys:function(){return this.each(function(){b(this).unbind("keydown.jqGrid")})},getLocalRow:function(b){var c=!1,d;this.each(function(){void 0!==b&&(d=this.p._index[Na(this.p.idPrefix,b)],0<=d&&(c=this.p.data[d]))});return c},progressBar:function(a){a=b.extend({htmlcontent:"",method:"hide",
loadtype:"disable"},a||{});return this.each(function(){var c="show"===a.method?!0:!1,d=G(this.p.id),e=b("#load_"+d);""!==a.htmlcontent&&e.html(a.htmlcontent);switch(a.loadtype){case "enable":e.toggle(c);break;case "block":b("#lui_"+d).toggle(c),e.toggle(c)}})},setColWidth:function(a,c,d,e){return this.each(function(){var f=b(this),g=this.grid,k=this.p,m;if("string"===typeof a){if(a=k.iColByName[a],void 0===a)return}else if("number"!==typeof a)return;m=g.headers[a];null!=m&&(m.newWidth=c,g.newWidth=
k.tblwidth+c-m.width,g.resizeColumn(a,!k.frozenColumns,e),!1===d||e||(this.fixScrollOffsetAndhBoxPadding(),C.setGridWidth.call(f,g.newWidth+k.scrollOffset,!1)))})},getAutoResizableWidth:function(a){var c=this;if(0===c.length)return-1;var c=c[0],d,e,f,g,k=c.p,m=k.colModel[a],l=b(c.grid.headers[a].el);f=l.find(">div");g=parseFloat(l.css("padding-left")||0);d=parseFloat(l.css("padding-right")||0);e=f.find("span.s-ico");var n=f.find(">."+k.autoResizing.wrapperClassName),p=n.outerWidth(),q=parseFloat(n.css("width")||
0),r=l=0,t=null!=m.autoResizing&&void 0!==m.autoResizable.compact?m.autoResizable.compact:k.autoResizing.compact,w=k.autoResizing.wrapperClassName;if(null==m||!m.autoResizable||0===n.length||m.hidden||u.isCellClassHidden(m.classes)||m.fixed)return-1;if(!t||e.is(":visible")||"none"!==e.css("display"))r=e.outerWidth(!0),k.sortIconsBeforeText||(r-="rtl"===k.direction?parseFloat(e.css("padding-left")||0)+parseFloat(e.css("margin-left")||0):parseFloat(e.css("padding-right")||0)+parseFloat(e.css("margin-right")||
...
n,!1);c.autoResizing.fixWidthOnShrink=l;c.autoResizing.adjustGridWidth=m;c.shrinkToFit=k})}});var va=function(a,c){var d=this.grid.fbRows;return b((null!=d&&d[0].cells.length>c?d[a.rowIndex]:a).cells[c])};u.extend({editCell:function(a,c,d){return this.each(function(){var e=this,f=b(e),g=e.p,k,m,l,n;k=e.rows;if(e.grid&&!0===g.cellEdit&&null!=k&&null!=k[a]&&(a=parseInt(a,10),c=parseInt(c,10),!isNaN(a)&&!isNaN(c))){var p=k[a],q=null!=p?p.id:null,r=b(p),t=parseInt(g.iCol,10),w=parseInt(g.iRow,10),y=b(k[w]),
x=g.savedRow;if(null!=q){g.selrow=q;g.knv||f.jqGrid("GridNav");if(0<x.length){if(!0===d&&a===w&&c===t)return;f.jqGrid("saveCell",x[0].id,x[0].ic)}else setTimeout(function(){b("#"+u.jqID(g.knv)).attr("tabindex","-1").focus()},1);n=g.colModel[c];k=n.name;if("subgrid"!==k&&"cb"!==k&&"rn"!==k){l=va.call(e,p,c);p=n.editable;b.isFunction(p)&&(p=p.call(e,{rowid:q,iCol:c,iRow:a,name:k,cm:n,mode:"cell"}));var D=f.jqGrid("getGuiStyles","states.select","edit-cell"),v=f.jqGrid("getGuiStyles","states.hover","selected-row");
if(!0!==p||!0!==d||l.hasClass("not-editable-cell"))0<=t&&0<=w&&(va.call(e,y[0],t).removeClass(D),y.removeClass(v)),l.addClass(D),r.addClass(v),m=l.html().replace(/&#160;/ig,""),R.call(e,"onSelectCell",q,k,m,a,c);else{0<=t&&0<=w&&(va.call(e,y[0],t).removeClass(D),y.removeClass(v));l.addClass(D);r.addClass(v);n.edittype||(n.edittype="text");r=n.edittype;try{m=b.unformat.call(e,l,{rowId:q,colModel:n},c)}catch(E){m="textarea"===r?l.text():l.html()}g.autoEncodeOnEdit&&(m=u.oldDecodePostedData(m));x.push({id:a,
ic:c,name:k,v:m});if("&nbsp;"===m||"&#160;"===m||1===m.length&&160===m.charCodeAt(0))m="";b.isFunction(g.formatCell)&&(t=g.formatCell.call(e,q,k,m,a,c),void 0!==t&&(m=t));R.call(e,"beforeEditCell",q,k,m,a,c);n=b.extend({},n.editoptions||{},{id:a+"_"+k,name:k,rowId:q,mode:"cell",cm:n,iCol:c});var A=u.createEl.call(e,r,n,m,!0,b.extend({},u.ajaxOptions,g.ajaxSelectOptions||{})),r=l;(t=!0===g.treeGrid&&k===g.ExpandColumn)&&(r=l.children("span.cell-wrapperleaf,span.cell-wrapper"));r.html("").append(A).attr("tabindex",
"0");t&&b(A).width(l.width()-l.children("div.tree-wrap").outerWidth());u.bindEv.call(e,A,n);setTimeout(function(){b(A).focus()},1);b("input, select, textarea",l).bind("keydown",function(d){27===d.keyCode&&(0<b("input.hasDatepicker",l).length?b(".ui-datepicker").is(":hidden")?f.jqGrid("restoreCell",a,c):b("input.hasDatepicker",l).datepicker("hide"):f.jqGrid("restoreCell",a,c));if(13===d.keyCode&&!d.shiftKey)return f.jqGrid("saveCell",a,c),!1;if(9===d.keyCode){if(e.grid.hDiv.loading)return!1;d.shiftKey?
f.jqGrid("prevCell",a,c):f.jqGrid("nextCell",a,c)}d.stopPropagation()});R.call(e,"afterEditCell",q,k,m,a,c);f.triggerHandler("jqGridAfterEditCell",[q,k,m,a,c])}g.iCol=c;g.iRow=a}}}})},saveCell:function(a,c){return this.each(function(){var d=this,e=b(d),f=d.p,g=u.info_dialog,k=u.jqID;if(d.grid&&!0===f.cellEdit){var m=e.jqGrid("getGridRes","errors"),l=m.errcap,n=e.jqGrid("getGridRes","edit").bClose,p=f.savedRow,q=1<=p.length?0:null;if(null!==q){var r=d.rows[a],t=r.id,w=b(r),y=f.colModel[c],x=y.name,
D,v=va.call(d,r,c),A={},E=u.getEditedValue.call(d,v,y,A);if(E!==p[q].v){D=e.triggerHandler("jqGridBeforeSaveCell",[t,x,E,a,c]);void 0!==D&&(E=D);b.isFunction(f.beforeSaveCell)&&(D=f.beforeSaveCell.call(d,t,x,E,a,c),void 0!==D&&(E=D));var F=u.checkValues.call(d,E,c,void 0,void 0,{oldValue:p[q].v,newValue:E,cmName:x,rowid:t,iCol:c,iRow:a,cm:y,tr:r,td:v,mode:"cell"}),r=y.formatoptions||{};if(null==F||!0===F||!0===F[0]){q=e.triggerHandler("jqGridBeforeSubmitCell",[t,x,E,a,c])||{};b.isFunction(f.beforeSubmitCell)&&
((q=f.beforeSubmitCell.call(d,t,x,E,a,c))||(q={}));0<b("input.hasDatepicker",v).length&&b("input.hasDatepicker",v).datepicker("hide");"date"===y.formatter&&!0!==r.sendFormatted&&(E=b.unformat.date.call(d,E,y));if("remote"===f.cellsubmit)if(f.cellurl){var h={};h[x]=E;var m=f.prmNames,r=m.oper,B=d.grid.hDiv;h[m.id]=u.stripPref(f.idPrefix,t);h[r]=m.editoper;h=b.extend(q,h);f.autoEncodeOnEdit&&b.each(h,function(a,c){b.isFunction(c)||(h[a]=u.oldEncodePostedData(c))});e.jqGrid("progressBar",{method:"show",
loadtype:f.loadui,htmlcontent:u.defaults.savetext||"Saving..."});B.loading=!0;b.ajax(b.extend({url:b.isFunction(f.cellurl)?f.cellurl.call(d,f.cellurl,a,c,t,E,x):f.cellurl,data:u.serializeFeedback.call(d,f.serializeCellData,"jqGridSerializeCellData",h),type:"POST",complete:function(k){e.jqGrid("progressBar",{method:"hide",loadtype:f.loadui});B.loading=!1;if((300>k.status||304===k.status)&&(0!==k.status||4!==k.readyState)){var m=e.triggerHandler("jqGridAfterSubmitCell",[d,k,h.id,x,E,a,c])||[!0,""];
if(null==m||!0===m||!0===m[0]&&b.isFunction(f.afterSubmitCell))m=f.afterSubmitCell.call(d,k,h.id,x,E,a,c);null==m||!0===m||!0===m[0]?(e.jqGrid("setCell",t,c,E,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),R.call(d,"afterSaveCell",t,x,E,a,c),p.splice(0,1)):(g.call(d,l,m[1],n),e.jqGrid("restoreCell",a,c))}},error:function(h,m,p){b("#lui_"+k(f.id)).hide();B.loading=!1;e.triggerHandler("jqGridErrorCell",[h,m,p]);b.isFunction(f.errorCell)?f.errorCell.call(d,h,m,p):g.call(d,l,h.status+" : "+h.statusText+
"<br/>"+m,n);e.jqGrid("restoreCell",a,c)}},u.ajaxOptions,f.ajaxCellOptions||{}))}else try{g.call(d,l,m.nourl,n),e.jqGrid("restoreCell",a,c)}catch(K){}"clientArray"===f.cellsubmit&&(e.jqGrid("setCell",t,c,"select"===y.edittype&&"select"!==y.formatter?A.text:E,!1,!1,!0),v.addClass("dirty-cell"),w.addClass("edited"),R.call(d,"afterSaveCell",t,x,E,a,c),p.splice(0,1))}else try{setTimeout(function(){g.call(d,l,E+" "+F[1],n)},100),e.jqGrid("restoreCell",a,c)}catch(K){}}else e.jqGrid("restoreCell",a,c)}setTimeout(function(){b("#"+
k(f.knv)).attr("tabindex","-1").focus()},0)}})},restoreCell:function(a,c){return this.each(function(){var d=this.p,e=this.rows[a],f=e.id,g,k;if(this.grid&&!0===d.cellEdit){var m=d.savedRow;g=va.call(this,e,c);if(1<=m.length){if(b.isFunction(b.fn.datepicker))try{b("input.hasDatepicker",g).datepicker("hide")}catch(l){}e=d.colModel[c];!0===d.treeGrid&&e.name===d.ExpandColumn?g.children("span.cell-wrapperleaf,span.cell-wrapper").empty():g.empty();g.attr("tabindex","-1");g=m[0].v;k=e.formatoptions||{};
...
role:"dialog","aria-labelledby":a.modalhead,"aria-hidden":"true"});void 0===d.drag&&(d.drag=!0);void 0===d.resize&&(d.resize=!0);if(d.drag)if(b.fn.jqDrag)b(r).css("cursor","move"),b(l).jqDrag(r);else try{b(l).draggable({handle:b("#"+m(r.id))})}catch(x){}if(d.resize)if(b.fn.jqResize)b(p).append("<div class='jqResize ui-resizable-handle ui-resizable-se "+d.resizingRightBottomIcon+"'></div>"),b(n).jqResize(".jqResize",q);else try{b(l).resizable({handles:"se, sw",alsoResize:q})}catch(x){}!0===d.closeOnEscape&&
...
!m&&(m=!1);a="";var l=P.call(f,"states.hover");if(0<k.buttons.length)for(e=0;e<k.buttons.length;e++)void 0===k.buttons[e].id&&(k.buttons[e].id="info_button_"+e),a+=u.builderFmButon.call(f,k.buttons[e].id,k.buttons[e].text);c="<div id='info_id'>"+("<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:"+(isNaN(k.dataheight)?k.dataheight:k.dataheight+"px")+";"+("text-align:"+k.align+";")+"'>"+c+"</div>");if(d||""!==a)c+="<hr class='"+P.call(f,"dialog.hr")+
...
case "select":k=document.createElement("select");n=[];a=null;!0===c.multiple?(e=!0,k.multiple="multiple",b(k).attr("aria-multiselectable","true"),n=d.split(","),n=b.map(n,function(a){return b.trim(a)})):(e=!1,n[0]=b.trim(d));void 0===c.size&&(c.size=e?3:1);try{a=c.rowId}catch(D){}l&&l.idPrefix&&(a=u.stripPref(l.idPrefix,a));if(void 0!==c.dataUrl){var w=c.postData||f.postData,t={elem:k,options:c,cm:c.cm,mode:c.mode,rowid:a,iCol:c.iCol,ovm:n};b.ajax(b.extend({url:b.isFunction(c.dataUrl)?c.dataUrl.call(m,
a,d,String(c.name),t):c.dataUrl,type:"GET",dataType:"html",data:b.isFunction(w)?w.call(m,a,d,String(c.name)):w,context:t,success:function(a,c,d){var e=this.ovm,f=this.elem,h=this.cm,k=this.iCol,l=b.extend({},this.options),n=this.rowid,p=this.mode;a=b.isFunction(l.buildSelect)?l.buildSelect.call(m,a,d,h,k):a;"string"===typeof a&&(a=b(b.trim(a)).html());a&&(b(f).append(a),g(f,l,w?["postData"]:void 0),setTimeout(function(){var a;b("option",f).each(function(c){0===c&&f.multiple&&(this.selected=!1);-1<
b.inArray(b.trim(b(this).val()),e)&&(a=this.selected=!0)});a||b("option",f).each(function(){-1<b.inArray(b.trim(b(this).text()),e)&&(this.selected=!0)});b(f).change();u.fullBoolFeedback.call(m,l.selectFilled,"jqGridSelectFilled",{elem:f,options:l,cm:h,rowid:n,mode:p,cmName:null!=h?h.name:l.name,iCol:k})},0))}},f||{}))}else if(c.value){"function"===typeof c.value&&(c.value=c.value());var y,x;f=[];l=void 0===c.separator?":":c.separator;r=void 0===c.delimiter?";":c.delimiter;p=function(b,a){if(0<a)return b};
if("string"===typeof c.value)for(r=c.value.split(r),y=0;y<r.length;y++)x=r[y].split(l),2<x.length&&(x[1]=b.map(x,p).join(l)),f.push({value:x[0],innerHtml:x[1],selectValue:b.trim(x[0]),selectText:b.trim(x[1]),selected:!1});else if("object"===typeof c.value)for(y in l=c.value,l)l.hasOwnProperty(y)&&f.push({value:y,innerHtml:l[y],selectValue:b.trim(y),selectText:b.trim(l[y]),selected:!1});for(y=0;y<f.length;y++)l=f[y],e||l.selectValue!==b.trim(d)||(t=l.selected=!0),e&&-1<b.inArray(l.selectValue,n)&&
(t=l.selected=!0);if(!t)for(y=0;y<f.length;y++)l=f[y],e||l.selectText!==b.trim(d)||(l.selected=!0),e&&-1<b.inArray(l.selectText,n)&&(l.selected=!0);for(y=0;y<f.length;y++)l=f[y],d=document.createElement("option"),d.value=l.value,d.innerHTML=l.innerHtml,l.selected&&(d.selected=!0),k.appendChild(d);g(k,c,["value"]);u.fullBoolFeedback.call(m,c.selectFilled,"jqGridSelectFilled",{elem:k,options:c,cm:c.cm,rowid:a,mode:c.mode,cmName:null!=c.cm?c.cm.name:c.name,iCol:c.iCol})}break;case "text":case "password":case "button":t=
"button"===a?"button":"textbox";k=document.createElement("input");k.type=a;g(k,c);k.value=d;"button"!==a&&(e?c.size||b(k).css({width:"100%","box-sizing":"border-box"}):c.size||(c.size=20));b(k).attr("role",t);break;case "image":case "file":k=document.createElement("input");k.type=a;g(k,c);break;case "custom":k=document.createElement("span");try{if(b.isFunction(c.custom_element))if(x=c.custom_element.call(m,d,c),x instanceof jQuery||u.isHTMLElement(x)||"string"===typeof x)x=b(x).addClass("customelement").attr({id:c.id,
name:c.name}),b(k).empty().append(x);else throw"editoptions.custom_element returns value of a wrong type";else throw"editoptions.custom_element is not a function";}catch(D){"e1"===D&&n.call(m,p,"function 'custom_element' "+r.nodefined,q),"e2"===D?n.call(m,p,"function 'custom_element' "+r.novalue,q):n.call(m,p,"string"===typeof D?D:D.message,q)}}return k},checkDate:function(b,c){var d={},e;b=b.toLowerCase();e=-1!==b.indexOf("/")?"/":-1!==b.indexOf("-")?"-":-1!==b.indexOf(".")?".":"/";b=b.split(e);
c=c.split(e);if(3!==c.length)return!1;var f=-1,g,k=e=-1,m;for(m=0;m<b.length;m++)g=isNaN(c[m])?0:parseInt(c[m],10),d[b[m]]=g,g=b[m],-1!==g.indexOf("y")&&(f=m),-1!==g.indexOf("m")&&(k=m),-1!==g.indexOf("d")&&(e=m);g="y"===b[f]||"yyyy"===b[f]?4:"yy"===b[f]?2:-1;var l;m=[0,31,29,31,30,31,30,31,31,30,31,30,31];if(-1===f)return!1;l=d[b[f]].toString();2===g&&1===l.length&&(g=1);if(l.length!==g||0===d[b[f]]&&"00"!==c[f]||-1===k)return!1;l=d[b[k]].toString();if(1>l.length||1>d[b[k]]||12<d[b[k]]||-1===e)return!1;
l=d[b[e]].toString();!(g=1>l.length||1>d[b[e]]||31<d[b[e]])&&(g=2===d[b[k]])&&(f=d[b[f]],g=d[b[e]]>(0!==f%4||0===f%100&&0!==f%400?28:29));return g||d[b[e]]>m[d[b[k]]]?!1:!0},isEmpty:function(b){return b.match(/^\s+$/)||""===b?!0:!1},checkTime:function(b){var c=/^(\d{1,2}):(\d{2})([apAP][Mm])?$/;if(!u.isEmpty(b))if(b=b.match(c)){if(b[3]){if(1>b[1]||12<b[1])return!1}else if(23<b[1])return!1;if(59<b[2])return!1}else return!1;return!0},checkValues:function(a,c,d,e,f){var g,k,m=this.p;k=m.colModel;var l=
u.isEmpty,n=na.call(b(this),"edit.msg"),p=na.call(b(this),"formatter.date.masks");if(void 0===d){"string"===typeof c&&(c=m.iColByName[c]);if(void 0===c||0>c)return[!0,"",""];e=k[c];d=e.editrules;null!=e.formoptions&&(g=e.formoptions.label)}else g=void 0===e?"_":e,e=k[c];if(d){g||(g=null!=m.colNames?m.colNames[c]:e.label);if(!0===d.required&&l(a))return[!1,g+": "+n.required,""];m=!1===d.required?!1:!0;if(!0===d.number&&(!1!==m||!l(a))&&isNaN(a))return[!1,g+": "+n.number,""];if(void 0!==d.minValue&&
...
avg:function(){return k.sum()}};if(!k[b])throw"jqGrid Grouping No such method: "+b;b=k[b]();null!=e&&("fixed"===f?b=b.toFixed(e):(e=Math.pow(10,e),b=Math.round(b*e)/e));return b}}});b.jgrid.extend({jqGridImport:function(a){a=b.extend({imptype:"xml",impstring:"",impurl:"",mtype:"GET",impData:{},xmlGrid:{config:"roots>grid",data:"roots>rows"},jsonGrid:{config:"grid",data:"data"},ajaxOptions:{}},a||{});return this.each(function(){var c=this,d=function(a,d){var e=b(d.xmlGrid.config,a)[0],f=b(d.xmlGrid.data,
...
{method:"show",loadtype:n.saveui,htmlcontent:n.savetext}),v=b.extend({},x,v),v[G]=u.stripPref(r.idPrefix,v[G]),r.autoEncodeOnEdit&&b.each(v,function(b,a){w(a)||(v[b]=u.oldEncodePostedData(a))}),b.ajax(b.extend({url:w(n.url)?n.url.call(p,v[G],l,v,n):n.url,data:u.serializeFeedback.call(p,w(n.serializeSaveData)?n.serializeSaveData:r.serializeRowData,"jqGridInlineSerializeSaveData",v),type:w(n.mtype)?n.mtype.call(p,l,n,v[G],v):n.mtype,complete:function(c,d){q.jqGrid("progressBar",{method:"hide",loadtype:n.saveui,
htmlcontent:n.savetext});if((300>c.status||304===c.status)&&(0!==c.status||4!==c.readyState)){var e,f;f=q.triggerHandler("jqGridInlineSuccessSaveRow",[c,a,n]);if(null==f||!0===f)f=[!0,x];f[0]&&w(n.successfunc)&&(f=n.successfunc.call(p,c));b.isArray(f)?(e=f[0],x=f[1]||x):e=f;if(!0===e){r.autoEncodeOnEdit&&b.each(x,function(b,a){x[b]=u.oldDecodePostedData(a)});x=b.extend({},x,D);q.jqGrid("setRowData",a,x);B.attr("editable","0");for(e=0;e<r.savedRow.length;e++)if(String(r.savedRow[e].id)===String(a)){E=
